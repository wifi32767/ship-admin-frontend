    ...
    <el-card>
      ...
      <div class="search-bar">
        <el-form :inline="true" :model="searchForm" class="search-form">
          ...
          <el-form-item label="关键词" v-if="activeTab === 'import'">
            <el-input
          ...
          <el-form-item label="模型名称" v-if="activeTab === 'spider'">
            <el-select
          ...
          <el-form-item>
            ...
            <el-button type="danger" @click="clearLogs" v-if="hasClearPermission">
